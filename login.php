...
if(isset($_POST['submit'])){
	...
	$sql="select * from admin_user where username='$sid' and password='$password'";
	...
	if($count>0){
		...
		if($row['role']==1){
			...
			header('location:Search_student_fee.php');
			die();
		}
	}else{
         ...
         <div class="card card-login mx-auto mt150">
            ...
            <div class="card-body">
               <form method="post">
				  ...
				  <?php echo $error?>
               <a link href="forgetpassword.php" > Forgot Password? </a>
			   </form>
            </div>
         </div>
      </div>
