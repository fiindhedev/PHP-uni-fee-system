...
while($row = $result->fetch_assoc()){
    ...
    <tr>
		...
		<td><?php echo $row['image']; ?></td>
			...
			<a href="update_student.php?uid=<?php echo $row['sid'];?>" >update</a>
				<a href="delete_student.php?rid=<?php echo $row['sid'];?>" onClick="return confirm('marabtaa inaad masaxdo?')" >Delete</a>
